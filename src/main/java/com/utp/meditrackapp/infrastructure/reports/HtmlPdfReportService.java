package com.utp.meditrackapp.infrastructure.reports;
...
/**
 * Implementación HTML/PDF del servicio de reportes.
 * Migrado desde HtmlReportService.
 */
public class HtmlPdfReportService implements ReportService {
    private final TemplateEngine templateEngine = PdfTemplateEngine.getInstance();

    @Override
    public void generarPdf(String templateName, Map<String, Object> variables, File outputFile) throws Exception {
    ...
    @Override
    public String generarGraficoBarras(Map<String, Double> data, String title, String xLabel, String yLabel) throws Exception {
    ...
    @Override
    public String generarGraficoCircular(Map<String, Double> data, String title) throws Exception {
        ...
        plot.setLabelPaint(new Color(30, 41, 59));
